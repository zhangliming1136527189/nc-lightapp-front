...
import { NCButton as Button, NCUpload as Upload, NCCol as Col, NCModal as Modal, NCIcon as Icon } from '../../base';
					...
					return (
						<div className="tmc_uploadr_item_content" title={fileItem.filename}>
							<img
								...
								src={Tscr}
								onClick={this.handleDownload.bind(this, fileItem.id, fileItem.filename)}
							/>
				...
				{showFile ? (
					<div className="tmc_uploader_files">
						<div className="head">
							...
							<div className="info">
								<span className="file_info_name">{fileInfo.name ? `${fileInfo.name} ` : null}</span>
